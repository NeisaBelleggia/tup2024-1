...
public class ClienteService {
    ...
    public Cliente darDeAltaCliente(Cliente cliente) throws ClienteAlreadyExistsException {
        ...
        if (String.valueOf(cliente.getDni()).length() != 8) {
            throw new IllegalArgumentException("El DNI debe tener exactamente 8 dígitos");
        }
    
        // Verifica que el tipo de persona sea válido (por ejemplo, "FISICA" o "JURIDICA")
        if (!cliente.getTipoPersona().matches("FISICA|JURIDICA")) {
